...
const REPO = 'AsrnkHoper/LX-Pro-Music'
...
const address = [
  [
    `https://raw.githubusercontent.com/${REPO}/master/publish/version.json`,
    'direct',
  ],
  // ['https://registry.npmjs.org/lx-music-mobile-version-info/latest', 'npm'],
  [`https://cdn.jsdelivr.net/gh/${REPO}/publish/version.json`, 'direct'],
  [`https://fastly.jsdelivr.net/gh/${REPO}/publish/version.json`, 'direct'],
  [`https://gcore.jsdelivr.net/gh/${REPO}/publish/version.json`, 'direct'],
